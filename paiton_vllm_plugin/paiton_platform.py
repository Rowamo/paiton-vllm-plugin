...
def _apply_paiton_common_config(vllm_config: "VllmConfig") -> None:
    ...
    if cache_config and cache_config.cache_dtype == "auto":
        qc = getattr(vllm_config.model_config.hf_config, "quantization_config", None)
    ...
    # Paiton compiled models already include fused kernels and are generally
    # not compatible with vLLM cudagraph/torch.compile paths.
...
class PaitonPlatform(RocmPlatform):
    ...
    def check_and_update_config(cls, vllm_config: "VllmConfig") -> None:
        ...
        _apply_paiton_common_config(vllm_config)
...
class PaitonCudaPlatform(CudaPlatform):
    """
    Platform implementation for running Paiton-compiled models on NVIDIA GPUs.
    """
    ...
    @classmethod
    def check_and_update_config(cls, vllm_config: "VllmConfig") -> None:
        # First apply CUDA base configuration
        super().check_and_update_config(vllm_config)
        _apply_paiton_common_config(vllm_config)
