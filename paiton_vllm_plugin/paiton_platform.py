...
class PaitonPlatform(RocmPlatform):
    ...
    def check_and_update_config(cls, vllm_config: "VllmConfig") -> None:
        ...
        # Auto-enable expert parallelism only when the compiled artifact was
        # explicitly built with ep_size > 1. GLM defaults to ep_size=1 and
        # tensor-parallels each expert over the TP group; --ep-size selects a
        # different compile-time topology. This must run before vLLM
        # initializes parallel state.
